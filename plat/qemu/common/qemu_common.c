...
#define MAP_NS_DRAM1_BL2	MAP_REGION_FLAT(NS_DRAM1_BASE_BL2, NS_DRAM1_SIZE_BL2,	\
					MT_MEMORY | MT_RW | MT_NS)

#define MAP_DEVICE_PMUSGRF 	MAP_REGION_FLAT(DEVICE_PMUSGRF_BASE, DEVICE_PMUSGRF_SIZE,			\
					MT_DEVICE | MT_RW | MT_NS)

#define MAP_NS_DRAM1_BL31	MAP_REGION_FLAT(NS_DRAM1_BASE_BL31, NS_DRAM1_SIZE_BL31,	\
					MT_MEMORY | MT_RW | MT_NS)
